...
<div class="body">
    <div class="panel">
            ...
            <form method="post" class="form" action="procesargrado.php">
                ...
                <input type="text" required name="ciclo" maxlength="45">
                <br><br>
                ...
                <br><br>-->
                <button type="submit" name="insertar">Guardar</button> <button type="reset">Limpiar</button> <a class="btn-link" href="listadogrados.view.php">Ver Listado</a>
                <br><br>
